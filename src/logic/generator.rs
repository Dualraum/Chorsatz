...
pub fn generate_hum_file(solution: &Vec<SatbBlock>) -> String {
    let mut s = String::new();
    s.push_str("~ SATB sheet generated by Chorsatz.\n");
    s.push_str("~ Minona Schäfer & Linus Mußmächer\n\n");
    s.push_str("[ 180_bpm ][ 3/4 ]\n\n");
